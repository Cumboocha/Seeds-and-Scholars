    ...
    return (
        <div className="resto-card" onClick={() => setLeftScreen("resto-profile")}>
            ...
            <div className="resto-card-info">
                ...
                <p className="resto-card-desc">Isang makabayan at masarap na kainan na naghahain ng mga paboritong lutong-bahay tulad ng adobo, siningang, at kare-kare, gamit ang sariwang sangkap mula sa palengke</p>
            </div>
